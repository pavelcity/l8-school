		...
		<div class="pl-3">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0 p-0">
					...
					<li class="breadcrumb-item active " aria-current="page"><a href="{{ route('dashboard.about.home') }}" class="text-info">about</a></li>
		...
		<div class="card-body">
			...
			<form action="{{ route('dashboard.about.update', $about->id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
				...
				<div class="card-title">
					...
					<a href="{{ route('dashboard.about.home') }}" class="btn btn-outline-info m-1 px-5 py-2">Назад</a>
				</div>
				<hr/>
			...
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				<li class="nav-item" role="presentation"> <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">about</a>
				</li>
			</ul>
			...
			<div class="tab-content p-3" id="myTabContent">
				...
				<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
							...
							<div class="form-group">
								...
								<input class="form-control form-control-lg" id="title" name="title" type="text" placeholder="Заголовок" value="{{ $about->title }}">
								@error('title')
