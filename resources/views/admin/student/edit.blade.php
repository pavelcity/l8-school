...
@section('title', 'Студенты изменить')
...
@section('content')
	...
	<div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
		<div class="breadcrumb-title pr-3">Студенты</div>
		<div class="pl-3">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0 p-0">
					<li class="breadcrumb-item"><a href="{{ route('dashboard.home') }}"><i class='bx bx-home-alt text-info'></i></a>
					</li>
					<li class="breadcrumb-item active " aria-current="page"><a href="{{ route('dashboard.student.home') }}" class="text-info">Студенты</a></li>
	...
	<div class="card radius-5">
		<div class="card-body">
			...
			@if(true)
			<form action="{{ route('dashboard.student.update', $student->id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
				@csrf
		
				<div class="card-title">
					<button type="submit" class="btn btn-info m-1 px-5 py-2">Сохранить</button>
					<a href="{{ route('dashboard.student.home') }}" class="btn btn-outline-info m-1 px-5 py-2">Назад</a>
				</div>
				<hr/>
			...
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				<li class="nav-item" role="presentation"> <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">student</a>
				</li>
			</ul>
			...
			<div class="tab-content p-3" id="myTabContent">
				...
				<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
							...
							<div class="form-group">
								...
								<input class="form-control form-control-lg" id="name" name="name" type="text" placeholder="имя" value="{{ $student->name }}">
								@error('name')
							...
							<div class="form-group">
								...
								<input class="form-control form-control-lg" id="email" name="email" type="text" placeholder="email" value="{{ $student->email }}">
								@error('email')
									<p style="color:red;">{{ $message }}</p>
								@enderror
							</div>
							...
							<div class="form-group">
								...
								<input class="form-control form-control-lg" id="phone" name="phone" type="text" placeholder="Телефон" value="{{ $student->phone }}">
								@error('phone')
									<p style="color:red;">{{ $message }}</p>
								@enderror
							</div>
