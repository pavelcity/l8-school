...
class ShedulerController extends Controller
{
	...
	public function index () {
		...
		return view ('admin.sheduler.index', compact('shedulers'));
	}
	...
	public function create () {
		...
		return view ('admin.sheduler.create', compact('teachers'));
	}
	...
	public function store (Request $request) {
		...
		return redirect()->route('dashboard.sheduler.home');
	}
	...
	public function edit ($id) {
		...
		return view ('admin.sheduler.edit', compact('sheduler', 'teachers'));
	}
